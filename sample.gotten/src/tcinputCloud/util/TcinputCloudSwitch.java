 ...
 * @generated
 */
public class TcinputCloudSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TcinputCloudPackage.DATA_CENTRE: {
				DataCentre dataCentre = (DataCentre)theEObject;
				T result = caseDataCentre(dataCentre);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TcinputCloudPackage.NETWORK: {
				Network network = (Network)theEObject;
				T result = caseNetwork(network);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TcinputCloudPackage.RACK: {
				Rack rack = (Rack)theEObject;
				T result = caseRack(rack);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TcinputCloudPackage.BOARD: {
				Board board = (Board)theEObject;
				T result = caseBoard(board);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TcinputCloudPackage.SWITCH: {
				tcinputCloud.Switch switch_ = (tcinputCloud.Switch)theEObject;
				T result = caseSwitch(switch_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TcinputCloudPackage.NODE_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Centre</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Centre</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDataCentre(DataCentre object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSwitch(tcinputCloud.Switch object) {
		return null;
	}
