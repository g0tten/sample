...
public class Datac_mr20 {
  ...
  protected final String[] nonSolutionParameters = new String[] { Datac_mr2Module.DecCPUCores.Parameter.X, Datac_mr2Module.DecCPUSpeed.Parameter.X };
  ...
  protected double _createObjectiveHelper_0(final TransformationSolution solution, final EGraph graph, final EObject root) {
    return FitnessFunctionForDatac_mr2.getCPuDistance(((DataCentre) root), Datac_mr20.INITIAL_MODEL);
  }
